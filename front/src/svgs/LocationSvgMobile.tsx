...
const LocationSvgMobile = () => {
  
    return ( 
        <>
        <svg version="1.0" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" 
	 width="25px" className={`absolute hover:animate-bounce left-[23.5%] bottom-[15%]`} height="25px" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" xmlSpace="preserve">
...
export default LocationSvgMobile;